...
class AppNetworkClient {
  ...
  static String? baseurl = 'http://fuzzyweb.work.gd'; // 'http://38.9.141.145:8080'; //  'http://localhost:8080'; //
  ...
  static Future<Response> delete({
    ...
    try {
      final res = await _dio.delete((url ?? baseurl)! + path, data: form ?? jsonMap ?? FormData.fromMap(data!));
  ...
  static Future<Response> post({
    ...
    try {
      final res = await _dio.post((url ?? baseurl)! + path, data: form ?? jsonMap ?? (data != null ? FormData.fromMap(data) : null));
